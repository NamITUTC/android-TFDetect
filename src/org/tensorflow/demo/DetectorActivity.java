...
//                                ImageUtils.saveBitmap(cropCopyBitmap);
                                LOGGER.i("Detect: %s", result);
                                try {
                                    cropImage(rgbFrameBitmap, location);
                                } catch (Exception e) {
                                    e.printStackTrace();
                                }
    ...
    private void cropImage(Bitmap bitmap, final RectF location) throws Exception {
        System.out.println("Loaction:" + location.left + ";" + location.top + ";" + location.right + ";" + location.bottom);
        System.out.println("cropBitMap:" + bitmap.getWidth() + ";" + bitmap.getHeight());
        System.out.println("cropBitMap:" + rgbFrameBitmap.getWidth() + ";" + rgbFrameBitmap.getHeight());
